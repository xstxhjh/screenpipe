...
description: "Fleet-deploy screenpipe enterprise to Windows machines via Microsoft Intune. Assign to a Microsoft Entra group and Intune installs screenpipe on every member's device automatically."
icon: "windows"
---
